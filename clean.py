...
#gl.glWindowPos2d(WIDTH, HEIGHT)
#create_opengl_context((WIDTH, HEIGHT))
glfw.create_window(WIDTH,HEIGHT)
gl.glClear(gl.GL_COLOR_BUFFER_BIT, 'x')

from OpenGL.GL import shaders
WIDTH, HEIGHT = 960, 720
#gl.glWindowPos2d(WIDTH,HEIGHT)
glfw.create_window(WIDTH, HEIGHT, 'x')
#create_opengl_context((WIDTH, HEIGHT))
...
mp_face_detection = mp.solutions.face_detections
